...
void CMinionShader::BuildObjects(shared_ptr<CCreateMgr> pCreateMgr, void *pContext)
{
	...
	m_ppMaterials[0]->SetAlbedo(XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	...
	m_ppMaterials[1]->SetAlbedo(XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	...
	m_ppMaterials[2]->SetAlbedo(XMFLOAT4(1.0f, 1.0f, 1.0f, 1.0f));
	// Red
