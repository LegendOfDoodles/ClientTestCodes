...
////////////////////////////////////////////////////////////////////////
// 공개 함수
void CGameScene::Initialize(shared_ptr<CCreateMgr> pCreateMgr)
{
...
void CGameScene::RenderWithLights()
{
	UpdateShaderVariables();
...
void CGameScene::SetViewportsAndScissorRects()
{
	m_pCamera->SetViewportsAndScissorRects();
}

void CGameScene::SetShadowViewportsAndScissorRects()
{
...
void CGameScene::UpdateShadowCamera(int renderStage)
{
	if (renderStage == 0)
	{
...
void CGameScene::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID,
	WPARAM wParam, LPARAM lParam)
{
...
////////////////////////////////////////////////////////////////////////
// 내부 함수
void CGameScene::CreateCbvAndSrvDescriptorHeap(shared_ptr<CCreateMgr> pCreateMgr, int nConstantBufferViews, int nShaderResourceViews, int index)
{
...
void CGameScene::CreateShaderVariables(shared_ptr<CCreateMgr> pCreateMgr)
{
...
void CGameScene::PickObjectPointedByCursor(WPARAM wParam, LPARAM lParam)
{
...
void CGameScene::OnProcessKeyUp(WPARAM wParam, LPARAM lParam)
{
