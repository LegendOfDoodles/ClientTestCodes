...
CMaterial * Materials::CreateMagicMinionMaterial(shared_ptr<CCreateMgr> pCreateMgr, D3D12_CPU_DESCRIPTOR_HANDLE * pSrvCPUDescriptorStartHandle, D3D12_GPU_DESCRIPTOR_HANDLE * pSrvGPUDescriptorStartHandle)
{
	CMaterial *pMaterial{ new CMaterial(pCreateMgr) };
	CTexture *pTexture{ new CTexture(1, RESOURCE_TEXTURE_2DARRAY, 0) };
...
CMaterial * Materials::CreateTextEffectMaterial(shared_ptr<CCreateMgr> pCreateMgr, D3D12_CPU_DESCRIPTOR_HANDLE * pSrvCPUDescriptorStartHandle, D3D12_GPU_DESCRIPTOR_HANDLE * pSrvGPUDescriptorStartHandle)
{
	CMaterial *pMaterial{ new CMaterial(pCreateMgr) };
	CTexture *pTexture{ new CTexture(5, RESOURCE_TEXTURE_2D, 0) };
	pTexture->LoadTextureFromFile(pCreateMgr, L"./Resource/Textures/Effect/TextEffect/kill.dds", 0);
	pTexture->LoadTextureFromFile(pCreateMgr, L"./Resource/Textures/Effect/TextEffect/dead.dds", 1);
	pTexture->LoadTextureFromFile(pCreateMgr, L"./Resource/Textures/Effect/TextEffect/miss.dds", 2);
	pTexture->LoadTextureFromFile(pCreateMgr, L"./Resource/Textures/Effect/TextEffect/recovery.dds", 3);
	pTexture->LoadTextureFromFile(pCreateMgr, L"./Resource/Textures/Effect/TextEffect/absorption.dds", 4);
...
// ------------------------------- 스프라이트 -------------------------------
CMaterial * Materials::CreateLoadingScreenMaterial(shared_ptr<CCreateMgr> pCreateMgr, D3D12_CPU_DESCRIPTOR_HANDLE * pSrvCPUDescriptorStartHandle, D3D12_GPU_DESCRIPTOR_HANDLE * pSrvGPUDescriptorStartHandle)
{
	CMaterial *pMaterial{ new CMaterial(pCreateMgr) };
	CTexture *pTexture{ new CTexture(1, RESOURCE_TEXTURE_2D, 0) };
...
CMaterial * Materials::CreateLogoScreenMaterial(shared_ptr<CCreateMgr> pCreateMgr, D3D12_CPU_DESCRIPTOR_HANDLE * pSrvCPUDescriptorStartHandle, D3D12_GPU_DESCRIPTOR_HANDLE * pSrvGPUDescriptorStartHandle)
{
	CMaterial *pMaterial{ new CMaterial(pCreateMgr) };
	CTexture *pTexture{ new CTexture(1, RESOURCE_TEXTURE_2DARRAY, 0) };
	pTexture->LoadTextureFromFile(pCreateMgr, L"./Resource/Sprites/LogoScreen/Logos.dds", 0);
...
CMaterial * Materials::CreateTitleScreenMaterial(shared_ptr<CCreateMgr> pCreateMgr, D3D12_CPU_DESCRIPTOR_HANDLE * pSrvCPUDescriptorStartHandle, D3D12_GPU_DESCRIPTOR_HANDLE * pSrvGPUDescriptorStartHandle)
{
	CMaterial *pMaterial{ new CMaterial(pCreateMgr) };
	CTexture *pTexture{ new CTexture(1, RESOURCE_TEXTURE_2D, 0) };
	pTexture->LoadTextureFromFile(pCreateMgr, L"./Resource/Sprites/TitleScreen/TitleImage.dds", 0);
...
CMaterial * Materials::CreateTitleButtonMaterial(shared_ptr<CCreateMgr> pCreateMgr, D3D12_CPU_DESCRIPTOR_HANDLE * pSrvCPUDescriptorStartHandle, D3D12_GPU_DESCRIPTOR_HANDLE * pSrvGPUDescriptorStartHandle)
{
	CMaterial *pMaterial{ new CMaterial(pCreateMgr) };
	CTexture *pTexture{ new CTexture(1, RESOURCE_TEXTURE_2DARRAY, 0) };
	pTexture->LoadTextureFromFile(pCreateMgr, L"./Resource/Sprites/TitleScreen/TitleButtons.dds", 0);
...
CMaterial * Materials::CreateRoomScreenMaterial(shared_ptr<CCreateMgr> pCreateMgr, D3D12_CPU_DESCRIPTOR_HANDLE * pSrvCPUDescriptorStartHandle, D3D12_GPU_DESCRIPTOR_HANDLE * pSrvGPUDescriptorStartHandle)
{
	CMaterial *pMaterial{ new CMaterial(pCreateMgr) };
	CTexture *pTexture{ new CTexture(1, RESOURCE_TEXTURE_2D, 0) };
	pTexture->LoadTextureFromFile(pCreateMgr, L"./Resource/Sprites/RoomScreen/RoomImage.dds", 0);
...
CMaterial * Materials::CreateRoomButtonMaterial(shared_ptr<CCreateMgr> pCreateMgr, D3D12_CPU_DESCRIPTOR_HANDLE * pSrvCPUDescriptorStartHandle, D3D12_GPU_DESCRIPTOR_HANDLE * pSrvGPUDescriptorStartHandle)
{
	CMaterial *pMaterial{ new CMaterial(pCreateMgr) };
	CTexture *pTexture{ new CTexture(1, RESOURCE_TEXTURE_2DARRAY, 0) };
	pTexture->LoadTextureFromFile(pCreateMgr, L"./Resource/Sprites/RoomScreen/RoomButtons.dds", 0);
...
CMaterial * Materials::CreateRoomCardsMaterial(shared_ptr<CCreateMgr> pCreateMgr, D3D12_CPU_DESCRIPTOR_HANDLE * pSrvCPUDescriptorStartHandle, D3D12_GPU_DESCRIPTOR_HANDLE * pSrvGPUDescriptorStartHandle)
{
	CMaterial *pMaterial{ new CMaterial(pCreateMgr) };
	CTexture *pTexture{ new CTexture(1, RESOURCE_TEXTURE_2DARRAY, 0) };
	pTexture->LoadTextureFromFile(pCreateMgr, L"./Resource/Sprites/RoomScreen/RoomCards.dds", 0);
