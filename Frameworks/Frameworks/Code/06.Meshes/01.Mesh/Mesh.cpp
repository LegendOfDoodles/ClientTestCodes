...
CSkinnedMesh::CSkinnedMesh(CCreateMgr * pCreateMgr, char* in) : CMeshIlluminatedTextured(pCreateMgr)
{
	...
	int nVertices = m_nVerticesCnt = importer.m_iVerticesCnt;
	XMFLOAT3* pxmf3Positions = new XMFLOAT3[nVertices];
	XMFLOAT3* pxmf3Normals = new XMFLOAT3[nVertices];
	...
	xmf3Scale)
{
	...
	/*ÀÌ¹ÌÁöÀÇ y-Ãà°ú ÁöÇüÀÇ z-ÃàÀÌ ¹æÇâÀÌ ¹Ý´ëÀÌ¹Ç·Î ÀÌ¹ÌÁö¸¦ »óÇÏ´ëÄª ½ÃÄÑ ÀúÀåÇÑ´Ù. ±×·¯¸é ´ÙÀ½ ±×¸²°ú °°ÀÌ ÀÌ
...
XMFLOAT3 CHeightMapImage::GetHeightMapNormal(int x, int z)
{
	...
	/*³ôÀÌ ¸Ê¿¡¼­ (x, z) ÁÂÇ¥ÀÇ ÇÈ¼¿ °ª°ú ÀÎÁ¢ÇÑ µÎ °³ÀÇ Á¡ (x+1, z), (z, z+1)¿¡ ´ëÇÑ ÇÈ¼¿ °ªÀ» »ç¿ëÇÏ¿© ¹ý¼± º¤ÅÍ¸¦
	°è»êÇÑ´Ù.*/
...
{
	/*ÁöÇüÀÇ ÁÂÇ¥ (fx, fz)´Â ÀÌ¹ÌÁö ÁÂÇ¥°èÀÌ´Ù. ³ôÀÌ ¸ÊÀÇ x-ÁÂÇ¥¿Í z-ÁÂÇ¥°¡ ³ôÀÌ ¸ÊÀÇ ¹üÀ§¸¦ ¹þ¾î³ª¸é ÁöÇüÀÇ ³ôÀÌ´Â
	0ÀÌ´Ù.*/
