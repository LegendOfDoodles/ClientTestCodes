...
{
	Safe_Delete_Array(m_pHeightMapPixels);
}
...
CHeightMapGridMesh::CHeightMapGridMesh(CCreateMgr *pCreateMgr, int xStart, int zStart, int nWidth,
	int nLength, XMFLOAT3 xmf3Scale, XMFLOAT4 xmf4Color, void *pContext) : CMesh(pCreateMgr)
{
