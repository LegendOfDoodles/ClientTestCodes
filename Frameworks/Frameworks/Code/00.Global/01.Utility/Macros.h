...
#define TERRAIN_IMAGE_SCALE XMFLOAT3(TERRAIN_SIZE_WIDTH / TERRAIN_IMAGE_WIDTH, 1.4, TERRAIN_SIZE_HEIGHT / TERRAIN_IMAGE_HEIGHT)

#define TERRAIN_IMAGE_CELL_WIDTH 50.0f
#define TERRAIN_IMAGE_CELL_HEIGHT 25.0f
#define TERRAIN_IMAGE_CELL_SCALE XMFLOAT3(TERRAIN_SIZE_WIDTH / TERRAIN_IMAGE_CELL_WIDTH, 1.4, TERRAIN_SIZE_HEIGHT / TERRAIN_IMAGE_CELL_HEIGHT)

#define TETRRAIN_COLLISION_WIDTH 500.0f
#define TETRRAIN_COLLISION_HEIGHT 250.0f
#define TERRAIN_COLLISION_SCALE XMFLOAT3(TERRAIN_SIZE_WIDTH / TETRRAIN_COLLISION_WIDTH, 1.4, TERRAIN_SIZE_HEIGHT / TETRRAIN_COLLISION_HEIGHT)
