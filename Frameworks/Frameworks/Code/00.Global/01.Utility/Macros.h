...
#define TERRAIN_IMAGE_WIDTH 4000
#define TERRAIN_IMAGE_HEIGHT 2000
#define TERRAIN_IMAGE_SCALE XMFLOAT3(TERRAIN_SIZE_WIDTH / TERRAIN_IMAGE_WIDTH, 0.7, TERRAIN_SIZE_HEIGHT / TERRAIN_IMAGE_HEIGHT)

#define TERRAIN_IMAGE_CELL_WIDTH 50
#define TERRAIN_IMAGE_CELL_HEIGHT 25
#define TERRAIN_IMAGE_CELL_SCALE XMFLOAT3(TERRAIN_SIZE_WIDTH / TERRAIN_IMAGE_CELL_WIDTH, 0.7, TERRAIN_SIZE_HEIGHT / TERRAIN_IMAGE_CELL_HEIGHT)

#define TETRRAIN_COLLISION_WIDTH 1000
#define TETRRAIN_COLLISION_HEIGHT 500
#define TERRAIN_COLLISION_SCALE XMFLOAT3(TERRAIN_SIZE_WIDTH / TETRRAIN_COLLISION_WIDTH, 0.7, TERRAIN_SIZE_HEIGHT / TETRRAIN_COLLISION_HEIGHT)

#define REVISE_HEIGHT 153
#define REVISE_HEIGHT_FOR_OBJECT REVISE_HEIGHT + 147.0f
