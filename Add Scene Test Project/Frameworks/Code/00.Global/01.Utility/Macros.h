...
// Game Start Window Screen 범위
#define GAMESTART_AND_CONNECT_MINIMUM_X FRAME_BUFFER_WIDTH / 5.2459f		// 244
#define GAMESTART_AND_CONNECT_MAXIMUM_X FRAME_BUFFER_WIDTH / 2.4150f		// 530
#define GAMESTART_AND_CONNECT_MINIMUM_Y FRAME_BUFFER_HEIGHT / 1.2972f		// 532
#define GAMESTART_AND_CONNECT_MAXIMUM_Y FRAME_BUFFER_HEIGHT / 1.0344f		// 696
		
#define EXIT_AND_PREV_MINIMUM_X FRAME_BUFFER_WIDTH / 1.6710f				// 766
#define EXIT_AND_PREV_MAXIMUM_X FRAME_BUFFER_WIDTH / 1.2237f				// 1046
#define EXIT_AND_PREV_MINIMUM_Y FRAME_BUFFER_HEIGHT / 1.3533f				// 532
#define EXIT_AND_PREV_MAXIMUM_Y FRAME_BUFFER_HEIGHT / 1.0344f				// 696
