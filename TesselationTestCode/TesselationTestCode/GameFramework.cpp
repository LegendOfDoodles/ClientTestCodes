...
void CGameFramework::BuildObjects()
{
	...
	m_pCamera->GenerateProjectionMatrix(1.0f, 50000.0f, float(m_nWndClientWidth) /
		float(m_nWndClientHeight), 90.0f);
	m_pCamera->GenerateViewMatrix(XMFLOAT3(0.0f, 50.0f, -50.0f), XMFLOAT3(0.0f, 0.0f, 0.0f),
